document.addEventListener("DOMContentLoaded", () => {
  ...
  const galleryImages = {
    ...
    planet2: ["assets/images/Call_Me_2.jpeg", "assets/images/Call_Me_1.jpeg", "assets/images/Call_Me_3.jpeg", "assets/images/Call_Me_4.jpeg", "assets/images/Call_Me_5.jpeg", "assets/images/Call_Me_6.jpeg", "assets/images/Call_Me_7.jpeg"],
  ...
  const planetGalleryInfo = {
    ...
    planet4: "+++ »hawehrtsich« +++ Leon Rebolledo Godoy (@hawehrtsich) +++ Bachelorarbeit KoDe 2024 +++ KoDe&Studierende des Departments +++ »#hawehrtsich: Das Plakat als kollektive Kommunikationsplattform« gibt Studierenden des Departments Design der HAW eine Möglichkeit in Form von gedruckten oder von Hand beschriebenen Plakaten ihre Sorgen und Wünsche bezüglich der Unterfinanzierung der Hochschule zu äußern. Die Plakate hingen 2023 an den beiden Standorten des Departments- Finkenau und Armgartstraße. Zusätzlich ist eine Auswahl der Plakate auf dem Instagram-Account @hawehrtsich zu sehen. +++",
    planet5: "+++ »Live-Fotosession« +++ Charly Krüger (@ckrueger.png), Luca Engels (@lucamarieengels) +++ WiSe24/25 +++ KoDe&Mode +++ Im Rahmen des Rundgangs an der Armgartstraße am 14. Februar 2025 haben Luca Engels und Charly Krüger im Eingangsbereich eine Live-Fotosession zur Modeperformance manualMODE inszeniert. Die Modestudierenden konnten ihre Looks und Models in Szene setzen, während wir sie in Look- und Detailaufnahmen fotografisch festhielten. Besuchende des Rundgangs konnten uns dabei live über die Schulter schauen. ",
